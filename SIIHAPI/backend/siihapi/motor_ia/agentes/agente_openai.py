"""SIIHAPI · Agente OpenAI (Fase 3, 2026-09-04)."""
from ..llm import (
...
class AgenteOpenAI(AgenteIA):
    codigo = 'OPENAI'
    nombre_visible = 'OpenAI GPT-4o mini'
    descripcion = 'GPT-4o-mini vía OPENAI_API_KEY.'
    icono = '🟢'
    ...
    def analizar_horario(self, datos: dict):
        return analizar_horario_con_ia(datos, forzar_proveedor='OPENAI')
